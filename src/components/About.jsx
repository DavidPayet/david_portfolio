      ...
      <Container className="about">
        ...
        <Row>
          ...
          <Col xl="8" lg="8" md="8" sm="12" xs="12">
            ...
            <p>Le challenge et les défis de ce domaine font désormais partis de mon quotidien et les obstacles franchis m'apporte satisfactions <em>(Courtes certes, mais ça vaut le coup :)</em>.</p>
